// ============================================================================
// Domain types shared by the React client and the API server. This is the
// single source of truth for the data contracts: the server's repositories
// and controllers, and the client's API modules, all type against these.
// ============================================================================
...
export interface ForecastTemplate {
  ...
  /** True when the original .xlsx is stored server-side and downloadable. */
  hasFile?: boolean;
}
...
/** Approval decisions for a cycle: entity name → status. */
export type ApprovalMap = Record<string, SubmissionStatus>;
