...
| **Questions** (Treasury) | The queue of every question treasury and the approvers have asked, across every forecast: counts of what is awaiting a reply / answered / closed, filters by state, asker, region and period, and **one collapsed row per forecast** — country, week, submitter, counts and the longest wait — ordered by who has been waiting longest. Opening one shows each question with the reply beneath it, **Open Forecast** onto the cell, **Ask Again**, and **Mark Reviewed** to close it off |
