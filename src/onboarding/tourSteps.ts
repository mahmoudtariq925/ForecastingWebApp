...
const TREASURY_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: 'Inflows and outflows stacked per day across the whole group. Tick a past cycle to overlay it, and click any column to see which countries are behind it.',
    side: 'top',
  },
  {
    view: 'dashboard',
